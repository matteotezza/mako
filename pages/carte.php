...
<div class="header">
    ...
    <div class="contenitore4">
        ...
        <p class="centered">COLPO FUSIONE</p>
        <div class="contenitore6">
        ...
        <p class="centered">ECLISSI COSMICA</p>
        <div class="contenitore6">
        ...
        <p class="centered">FIAMME OSCURE</p>
        <div class="contenitore6">
        ...
        <p class="centered">FRAGORE RIBELLE</p>
        <div class="contenitore6">
        ...
        <p class="centered">FUTURI CAMPIONI</p>
        <div class="contenitore6">
        ...
        <p class="centered">LEGAMI INOSSIDABILI</p>
        <div class="contenitore6">
        ...
        <p class="centered">REGNO GLACIALE</p>
        <div class="contenitore6">
        ...
        <p class="centered">STILI DI LOTTA</p>
        <div class="contenitore6">
        ...
        <p class="centered">VOLTAGGIO SFOLGORANTE</p>
        <div class="contenitore6">
